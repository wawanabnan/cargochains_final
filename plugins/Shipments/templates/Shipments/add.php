 ...
 * @var \Cake\Collection\CollectionInterface|string[] $shipper
 * @var \Cake\Collection\CollectionInterface|string[] $consignee
 * @var \Cake\Collection\CollectionInterface|string[] $carrier
 * @var \Cake\Collection\CollectionInterface|string[] $agency
 */
?>
<div class="row">
    <aside class="column">
